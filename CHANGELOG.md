...
### Added
- Support for n8n notifications.

### Fixed
- Remote storage failure handling now avoids an extra one-minute wait and
  duplicate retry behavior when the storage is unreachable or unauthorized.
...
[1.11.2]: https://github.com/bqckup/bqckup/compare/v1.11.1...v1.11.2
